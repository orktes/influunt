...
res = influunt_core.executor_run(executor, {a: 123}, [b, c, randomListMap, trueVal, falseVal, json, m, isFoo, notFoo])

assert res == [321, 444, [1, 3, 5], False, True, '{"foo": "bar", "biz": "foo"}', {'biz': 'foo', 'foo': 'bar'}, 'foo', 'bar']
print(res)